...
<div class="fixed-action-btn" style="bottom: 0px; right: 0px;">
    <a class="btn-floating   waves-effect waves-light" style="background-color: #DEAB0E;">
      <i class="fas fa-pencil-alt"></i>
    </a>

    <ul class="list-unstyled">
      <li ><a class="btn-floating waves-effect waves-light" style="background-color: #C13584;"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
      <li><a class="btn-floating darken-1 waves-effect waves-light" style="background-color: #3b5998 ;"><i class="fab fa-facebook-f"></i></a></li>
      <li><a class="btn-floating  waves-effect waves-light"style="background-color:#c71610;" href="mailto:romeojuliet.fruits@gmail.com"><i class="fab fa-google"></i></a></li>
    </ul>
  </div>
